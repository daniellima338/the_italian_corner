"""
Django settings for the_italian_corner project.
...
SECRET_KEY = os.environ.get('SECRET_KEY_ITALIAN_CORNER', '')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = 'DEVELOPMENT' in os.environ

ALLOWED_HOSTS = ['the-italian-corner.herokuapp.com', 'localhost']
...
ROOT_URLCONF = 'the_italian_corner.urls'
...
WSGI_APPLICATION = 'the_italian_corner.wsgi.application'
...
if 'USE_AWS' in os.environ:
    # Cache control. Tells the browser that it is okay to cache static files.
    # It will improve performance of the site.
